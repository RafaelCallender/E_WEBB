...
namespace E_WEBB.MODEL.CONTACT_US_MODEL
{
    public class Contact_Us_Model01
    {
        ...
        public string data05 { get; set; } = string.Empty;
		     public string data06 { get; set; } = string.Empty;
			      public string data07 { get; set; } = string.Empty;
				      public string data08 { get; set; } = string.Empty;
					      public string data09 { get; set; } = string.Empty;
