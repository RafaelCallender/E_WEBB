...
namespace E_WEBB.SERVICES.SQL.SQL_SERVICES.SQL_CLIENT_SERVICES
{
    public class Sql_Client_Services01
    {
        ...
        {
            Sql_Client01_Manager01.conn[(int)Sql_Client01_Manager01.Connection_strings.Connection01].Open();
            Sql_Client01_Manager01.cmd[(int)Sql_Client01_Manager01.command_strings.find_client_emailkey_by_name].CommandType = CommandType.StoredProcedure;
            Sql_Client01_Manager01.cmd[(int)Sql_Client01_Manager01.command_strings.find_client_emailkey_by_name].Parameters.Clear();
            Sql_Client01_Manager01.cmd[(int)Sql_Client01_Manager01.command_strings.find_client_emailkey_by_name].Parameters.AddWithValue("@client_name", input);
            using (SqlDataReader reader = Sql_Client01_Manager01.cmd[(int)Sql_Client01_Manager01.command_strings.find_client_emailkey_by_name].ExecuteReader())
            {
                if (reader.Read())
                {
        ...
        {
            Sql_Client01_Manager01.conn[(int)Sql_Client01_Manager01.Connection_strings.Connection01].Open();
            Sql_Client01_Manager01.cmd[(int)Sql_Client01_Manager01.command_strings.find_client_cashapp_by_name].CommandType = CommandType.StoredProcedure;
            Sql_Client01_Manager01.cmd[(int)Sql_Client01_Manager01.command_strings.find_client_cashapp_by_name].Parameters.Clear();
            Sql_Client01_Manager01.cmd[(int)Sql_Client01_Manager01.command_strings.find_client_cashapp_by_name].Parameters.AddWithValue("@client_name", input);
            using (SqlDataReader reader = Sql_Client01_Manager01.cmd[(int)Sql_Client01_Manager01.command_strings.find_client_cashapp_by_name].ExecuteReader())
            {
                if (reader.Read())
                {
